...
const Contact = () => {
  return (
    <section className="bg-[#384D3A] text-center p-8">
      ...
      <div className="flex justify-around items-center py-10 w-full">
        <form action="" className="flex flex-col justify-center w-[40%]">
          ...
          <textarea
            ...
            className="mb-4 rounded-md w-full py-2 px-3"
          ></textarea>
          <button className="bg-[#f39c12] mb-2 rounded-md w-[30%] self-end p-2">
            Send Message
          </button>
        </form>
        <div className="absolute h-[50%] w-0.5 bg-[#f39c12] left-1/2 transform -translate-x-1/2"></div>
        <div className="flex flex-col justify-center items-start text-white w-[40%] pl-6">
